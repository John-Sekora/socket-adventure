...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in the room with the white wallpaper. Nobody has left a stain.",
            "You are in the room with the green wallpaper. Mold and spearmint fill the air.",
            "You are in the room with the brown wallpaper. Smokers have been in this place, playing bingo.",
            "You are in the room with the mauve wallpaper. Nobody knows what color that is...",
        ][room_number]
